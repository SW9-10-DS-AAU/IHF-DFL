...
config = ExperimentConfiguration(contribution_score_strategy="accuracy_loss", minimum_rounds=10, force_merge_all=False, freerider_noise_scale=0.0, malicious_noise_scale=0.0, punish_factor=1, punish_factor_contrib=3, freerider_start_round=5, malicious_start_round=5) # OVERSKRIV variabler her for testing. eksempel: config = ExperimentConfiguration(minimum_rounds=1), hvis du kun vil køre een round#DATASET = "cifar-10"
